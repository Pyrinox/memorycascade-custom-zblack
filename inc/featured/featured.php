<div class="featured-area <?php if(!get_theme_mod('zblack_promo')) : ?>nopromo<?php endif; ?>">
	...
	<div class="sideslides">
		...
		<div class="bxslider">
			...
			<?php
				...
				$featured_cat = get_theme_mod( 'zblack_featured_cat' );
				$get_featured_posts = get_theme_mod('zblack_featured_id');
				$number = get_theme_mod( 'zblack_featured_slider_slides' );
			...
			<div class="feat-item" style="background-image:url(<?php $image = wp_get_attachment_image_src( get_post_thumbnail_id($post->ID), 'slider-thumb' ); if(!$image) { echo get_template_directory_uri() . '/img/slider-default.png'; } else { echo $image[0]; } ?>);">
				...
				<div class="feat-overlay">
					<div class="feat-inner">
						...
						<a href="<?php echo get_permalink(); ?>" class="feat-more"><?php _e( 'Continue Reading →', 'zblack' ); ?></a>
					</div>
				</div>
