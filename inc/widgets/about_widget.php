...
add_action( 'widgets_init', 'zblack_about_load_widget' );

function zblack_about_load_widget() {
	register_widget( 'zblack_about_widget' );
}

class zblack_about_widget extends WP_Widget {

	public function __construct() {

		$widget_ops = array('classname' => 'zblack_about_widget', 'description' => esc_html__('A widget displaying your information.', 'zblack'));

		parent::__construct('zblack_about_widget', esc_html__('ZBLACK: About Me', 'zblack'), $widget_ops);
