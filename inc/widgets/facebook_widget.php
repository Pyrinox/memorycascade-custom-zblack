...
add_action( 'widgets_init', 'zblack_facebook_load_widget' );

function zblack_facebook_load_widget() {
	register_widget( 'zblack_facebook_widget' );
}

class zblack_facebook_widget extends WP_Widget {

	public function __construct() {

		$widget_ops = array('classname' => 'zblack_facebook_widget', 'description' => esc_html__('A widget that displays a Facebook Like Box', 'zblack'));

		parent::__construct('zblack_facebook_widget', esc_html__('ZBLACK: Facebook Like Box', 'zblack'), $widget_ops);
	...
	function form( $instance ) {
		...
		<p>
			...
			<small>EG. http://www.facebook.com/zthemes.net</small>
		</p>
